...
public class Mechanical extends EngineeringCollege
{
	 String sub1;
     String sub2;
     String sub3;
	 Mechanical(String college_name,int college_id,String college_address,String sub1,String sub2,String sub3)
	 {
