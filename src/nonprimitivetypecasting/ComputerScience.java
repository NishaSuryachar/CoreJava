...
public class ComputerScience extends EngineeringCollege
{
    String sub1;
    String sub2;
    String sub3;
    ComputerScience(String college_name,int college_id,String college_address,String sub1,String sub2,String sub3)
    {
